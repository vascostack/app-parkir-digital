...
class CreateKendaraanTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'id_kendaraan' => ['type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'id_user'      => ['type' => 'INT', 'constraint' => 11, 'unsigned' => true],
            'no_polisi'    => ['type' => 'VARCHAR', 'constraint' => 20, 'unique' => true],
            'jenis'        => ['type' => 'ENUM', 'constraint' => ['mobil', 'motor']],

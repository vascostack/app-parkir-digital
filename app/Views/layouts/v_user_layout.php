...
<head>
  ...
  <style>
    ...
    .nav-item-custom i { font-size: 1.2rem; }
    .premium-card {
      background-color: #ffffff;
    ...
    .premium-card:hover { transform: translateY(-2px); box-shadow: var(--card-shadow-hover); }
    .btn-navy { background-color: var(--navy-dark); color: #ffffff; border: none; font-weight: 500; padding: 0.65rem 1.5rem; border-radius: 10px; transition: all 0.25s ease; }
    .btn-navy:hover { background-color: var(--navy-light); color: #ffffff; box-shadow: 0 4px 12px rgba(10, 22, 40, 0.15); }
    .btn-outline-navy { background-color: transparent; color: var(--navy-dark); border: 2px solid var(--navy-dark); font-weight: 600; padding: 0.6rem 1.4rem; border-radius: 10px; transition: all 0.25s ease; }
    .btn-outline-navy:hover { background-color: var(--navy-dark); color: #ffffff; }

...
<div class="card border-0 shadow-sm p-4 rounded-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        <div>
            ...
            <span class="text-muted small">Kelola data, role, dan status akun petugas parkir.</span>
        </div>
            ...
            <tbody>
                <?php $no = 1; if(!empty($petugas)): ?>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-navy-dark"><?= $p['nama'] ?></td>
                        <td>
                            <div class="small text-muted mb-1"><i class="bi bi-envelope me-1"></i> <?= $p['email'] ?></div>
                            <div class="small text-muted"><i class="bi bi-telephone me-1"></i> <?= $p['no_hp'] ?: '-' ?></div>
                        </td>
                        <td>
                            <?php if($p['role'] == 'admin'): ?>
                        ...
                        <td class="text-center">
                            ...
                            <!-- Tombol Hapus (Menggunakan class btn-hapus untuk memicu SweetAlert) -->
                    ...
                    <!-- MODAL EDIT PETUGAS (Diletakkan di dalam loop) -->

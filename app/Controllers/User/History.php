...
class History extends BaseController
{
    public function index()
    {
        ...
        // 2. Ambil data riwayat dari tabel reservasi, join ke slot dan lokasi agar infonya lengkap
        $dataHistory = $db->table('reservasi')
            ->select('reservasi.*, slot_parkir.kode_slot, lokasi_parkir.nama_lokasi, lokasi_parkir.alamat')
